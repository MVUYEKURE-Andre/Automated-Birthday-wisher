import smtplib
#
# my_email="mvuyekureandre@yahoo.com"
# password="gpfdxngxzrpvndsc"
# with smtplib.SMTP("smtp.mail.com") as connection:
#     connection.starttls()  # transport layer security
#     connection.login(user=my_email,password=password)
#     connection.sendmail(from_addr=my_email,to_addrs="mvuyekureandree@gmail.com"
#         ,msg="Subject: python test\n\n hello python is Good ")
# # connection.close()

my_email="mvuyekureandr@gmail.com"
password="dyid ctht jvhz lxya"
